...
Editorial copy reference for the Home Floorplan homepage.

This document mirrors the current live HTML copy. Edit this file first when reviewing wording, then apply approved changes to `index.html` and `it/index.html`.
...
Brand line: See your home differently.
